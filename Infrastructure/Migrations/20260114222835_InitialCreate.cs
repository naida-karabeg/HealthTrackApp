    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalParameters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthJournals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthJournals_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientParameters_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientParameters_MedicalParameters_ParameterId",
                        column: x => x.ParameterId,
                        principalTable: "MedicalParameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TherapyLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TherapyLogs_Therapies_TherapyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthJournals_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientParameters_ParameterId",
                table: "PatientParameters",
                column: "ParameterId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientParameters_PatientId_ParameterId_RecordedAt",
                table: "PatientParameters",
                columns: new[] { "PatientId", "ParameterId", "RecordedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Therapies_PatientId_IsActive",
                table: "Therapies",
                columns: new[] { "PatientId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_TherapyLogs_TherapyId",
                table: "TherapyLogs",
                column: "TherapyId");
        }
